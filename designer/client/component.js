...
import ComponentEdit, { ComponentEditFn } from "./component-edit";
...
export function Component(props) {
  ...
  const handleShowEditor = (e, value) => {
    e?.stopPropagation();
    setShowEditor(value);
  };
  ...
  return (
    <div>
      <div
        ...
        onClick={(e) => handleShowEditor(e, true)}
      >
        <DragHandle />
        <TagName />
      </div>
      <Flyout
        ...
        show={showEditor}
        onHide={(e) => handleShowEditor(e, false)}
      >
        <ComponentEditFn component={component} page={page} data={data} />
      </Flyout>
    </div>
  );
}
